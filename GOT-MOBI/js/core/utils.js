...
// Установка сообщения в интерфейсе
...
// Трата денег (принимает цену в МЕДИ)
...
// Получение цены ресурса
function getResourcePrice(resourceType, quality) {
    const basePrices = {
        'leather': 5, 'iron': 8, 'wood': 3, 'steel': 20,
        'coal': 4, 'valyrian_ore': 50000, 'valyrian_steel': 100000
    };
...
// Добавление предмета в инвентарь (с учётом стеков)
...
// Нормализация инвентаря (объединение одинаковых стеков)
...
// Использование одного предмета из стека
